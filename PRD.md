...
```
 ...
 MSFT   │ $378.91  │ 375.10  │ 380.22  │ ▼ BEARISH │  38.1   │ Undervalued
 NVDA   │ $875.30  │ 880.00  │ 860.15  │ ▲ BULLISH │  71.8   │ Overbought
...
- **Trend signal** uses EMA crossover only (CLAUDE.md §5.4): EMA(10) > EMA(20) = Bullish, else Bearish.
- **Valuation** uses RSI only (CLAUDE.md §5.5): Oversold / Undervalued / Fair / Overvalued / Overbought.
